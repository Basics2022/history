...
filen = f'./../../maps/qgis/world_{year_list[0].replace("-","bc")}.shp'
...
political_data['color']       = '#C62828'   # 'rgb(128, 128, 128)'
political_data.at[0, 'color'] = '#FFFFFF'   # 'rgb(255, 0, 0)'
...
fig = px.choropleth_mapbox(
    ...
    geojson=political_data.geometry.__geo_interface__,
    locations=political_data.index,
    color=political_data['color'],
    hover_data=['NAME', 'PARTOF', 'SUBJECTO'],
...
def update_figure_year(political_year, history_years):
    ...
    filen = f'./../../maps/qgis/world_{year}.shp'
